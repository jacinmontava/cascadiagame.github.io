...
function checkScreenWidth(){
	...
	if(windowSize <= 1205) {
		if(currentView == 'desktop') changeOfView = true;
		currentView = 'tablet';
	} else {
		if(currentView == 'tablet') changeOfView = true;
		currentView = 'desktop';
	}
...
$(document).on(touchEvent,'#mapContainer #mapNavigation .navArrow',function(){
	...
	processMapMovement(direction[0]);
});
...
function updateNextTurn(mode){
	...
	$('#turnsAndNatureTokenContainer #turnsLeftFigure').html(turnsLeft);
...
function endOfGameSetup() {
	...
	setTimeout(function(){
		...
		$('#scoringTable-mobileFinalScoringModalTrigger').prepend('<img class="mobileActiveScoringFrame" src="img/mobileScoringGoal-active-alt2.png" />');
...
$(document).on('mouseover','.mobileFinalScoringItemTrigger:not(.lockTrigger).mobileActiveScoringItemTrigger .mobileGoalScoringTransparentLayer',function(){
	...
	$(this).after('<img class="mobileHoverScoringFrame" src="img/mobileScoringGoal-hover-alt2.png" />');
...
$(document).on(touchEvent,'.mobileFinalScoringItemTrigger:not(.lockTrigger).mobileActiveScoringItemTrigger .mobileGoalScoringTransparentLayer',function(){
	...
	setTimeout(function(){
		...
		$('#' + parentID).prepend('<img class="mobileActiveScoringFrame" src="img/mobileScoringGoal-active-alt2.png" />')
	}, 200)
